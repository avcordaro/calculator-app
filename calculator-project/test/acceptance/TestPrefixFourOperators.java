 ...
 * requirements: "Some people in our company want to use reverse polish notation whilst some 
 * others want standard infix". This test will prove that prefix expressions including all four 
 * operators and whole numbers can be correctly evaluated.
 * @author Alex Cordaro ZDAC051
 */
public class TestPrefixFourOperators {
