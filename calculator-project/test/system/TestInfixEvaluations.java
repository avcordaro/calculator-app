...
/**
 * System test for release_v1.1_infix_calculator, to show that the calculator can evaluate infix 
 * expressions of varying complexity, including attention to brackets and operator precedence. 
 * @author Alex Cordaro ZDAC051
 */
public class TestInfixEvaluations {
  ...
  public void testDivideExpressions() throws InvalidExpressionException, 
    ...
    assertEquals("evaluating 5678 + 6768", stdCalc.evaluate("2963 / 943"), 3.14209968, 0.000001);
  }
